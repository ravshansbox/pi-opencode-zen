...
// Free models (visible with public key) - from opencode.ai/zen/v1/models
...
const allModels = [
	...
	{ id: "trinity-large-preview-free", name: "Trinity Large Preview Free", reasoning: true, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 131072, maxTokens: 65536 },
