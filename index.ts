...
const allModels = [
	...
	{ id: "claude-opus-4-5", name: "Claude Opus 4.5 (latest)", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 5, output: 25, cacheRead: 0.5, cacheWrite: 6.25 }, contextWindow: 200000, maxTokens: 64000 },
	{ id: "claude-opus-4-6", name: "Claude Opus 4.6", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 5, output: 25, cacheRead: 0.5, cacheWrite: 6.25 }, contextWindow: 1000000, maxTokens: 128000 },
	{ id: "claude-sonnet-4", name: "Claude Sonnet 4", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 3, output: 15, cacheRead: 0.3, cacheWrite: 3.75 }, contextWindow: 1000000, maxTokens: 64000 },
	{ id: "claude-sonnet-4-5", name: "Claude Sonnet 4.5 (latest)", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 3, output: 15, cacheRead: 0.3, cacheWrite: 3.75 }, contextWindow: 200000, maxTokens: 64000 },
	{ id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 3, output: 15, cacheRead: 0.3, cacheWrite: 3.75 }, contextWindow: 1000000, maxTokens: 64000 },
	{ id: "gemini-3-flash", name: "Gemini 3 Flash", reasoning: true, input: ["text", "image", "video", "audio", "pdf"], cost: { input: 0.5, output: 3, cacheRead: 0.05, cacheWrite: 0 }, contextWindow: 1048576, maxTokens: 65536 },
	{ id: "gemini-3-pro", name: "Gemini 3 Pro", reasoning: true, input: ["text", "image", "video", "audio", "pdf"], cost: { input: 2, output: 12, cacheRead: 0.2, cacheWrite: 0 }, contextWindow: 1048576, maxTokens: 65536 },
	{ id: "gemini-3.1-pro", name: "Gemini 3.1 Pro Preview", reasoning: true, input: ["text", "image", "video", "audio", "pdf"], cost: { input: 2, output: 12, cacheRead: 0.2, cacheWrite: 0 }, contextWindow: 1048576, maxTokens: 65536 },
	{ id: "glm-4.6", name: "glm-4.6", reasoning: true, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 202752, maxTokens: 131072 },
	{ id: "glm-4.7", name: "glm-4.7", reasoning: true, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 202752, maxTokens: 131072 },
	{ id: "glm-5", name: "glm-5", reasoning: true, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 202752, maxTokens: 131072 },
	{ id: "gpt-5", name: "GPT-5", reasoning: true, input: ["text", "image"], cost: { input: 1.25, output: 10, cacheRead: 0.125, cacheWrite: 0 }, contextWindow: 400000, maxTokens: 128000 },
	{ id: "gpt-5-codex", name: "GPT-5-Codex", reasoning: true, input: ["text", "image"], cost: { input: 1.25, output: 10, cacheRead: 0.125, cacheWrite: 0 }, contextWindow: 400000, maxTokens: 128000 },
	{ id: "gpt-5-nano", name: "GPT-5 Nano", reasoning: true, input: ["text", "image"], cost: { input: 0.05, output: 0.4, cacheRead: 0.005, cacheWrite: 0 }, contextWindow: 400000, maxTokens: 128000 },
	{ id: "gpt-5.1", name: "GPT-5.1", reasoning: true, input: ["text", "image"], cost: { input: 1.25, output: 10, cacheRead: 0.13, cacheWrite: 0 }, contextWindow: 400000, maxTokens: 128000 },
	{ id: "gpt-5.1-codex", name: "GPT-5.1 Codex", reasoning: true, input: ["text", "image"], cost: { input: 1.25, output: 10, cacheRead: 0.125, cacheWrite: 0 }, contextWindow: 400000, maxTokens: 128000 },
	...
	{ id: "gpt-5.2-codex", name: "GPT-5.2 Codex", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 1.75, output: 14, cacheRead: 0.175, cacheWrite: 0 }, contextWindow: 400000, maxTokens: 128000 },
	{ id: "gpt-5.3-codex", name: "GPT-5.3 Codex", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 1.75, output: 14, cacheRead: 0.175, cacheWrite: 0 }, contextWindow: 400000, maxTokens: 128000 },
	{ id: "gpt-5.3-codex-spark", name: "GPT-5.3 Codex Spark", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 1.75, output: 14, cacheRead: 0.175, cacheWrite: 0 }, contextWindow: 128000, maxTokens: 32000 },
	{ id: "gpt-5.4", name: "GPT-5.4", reasoning: true, input: ["text", "image", "pdf"], cost: { input: 2.5, output: 15, cacheRead: 0.25, cacheWrite: 0 }, contextWindow: 1050000, maxTokens: 128000 },
	...
	{ id: "gpt-5.4-pro", name: "GPT-5.4 Pro", reasoning: true, input: ["text", "image"], cost: { input: 30, output: 180, cacheRead: 0, cacheWrite: 0 }, contextWindow: 1050000, maxTokens: 128000 },
	{ id: "kimi-k2", name: "Kimi K2", reasoning: false, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 128000, maxTokens: 128000 },
	{ id: "kimi-k2-thinking", name: "kimi-k2-thinking", reasoning: true, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 262144, maxTokens: 262144 },
...
const endpoints: Record<string, EndpointConfig> = {
	...
	"trinity-large-preview-free": { api: "openai-completions", baseUrl: BASE_URL },
